...
def GetYahooOptions(request):
    if request.method == 'GET':
            
        Symbol = request.GET.get("symbol")
        detials = list(scrape_options(Symbol))
        return JsonResponse(detials,safe=False)
